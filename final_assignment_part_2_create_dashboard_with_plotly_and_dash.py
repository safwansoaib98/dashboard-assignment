...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign': 'left', 'color': '#000000', 'font-size': 0}),#Include style for title
...
def update_output_container(report_type, input_year):
    ...
    if report_type == 'Recession Period Statistics':
        ...
        return yearly_data
    # else:
    #     # Handle the case where the report type is not recognized or other invalid inputs
    #     return "Invalid report type or missing year for Yearly Statistics."
